...
object HOFs {
    ...
    // higher-order functions = functions that takes other functions as args/returns other functions as results
    val aHof: (Int, (Int) -> Int) -> Int = { x, func -> x + func(1) }
    val anotherHof: (Int) -> ((Int) -> Int) = { x -> {y -> y + 2 * x} } // returns function value
    // ^^^ curried function
    ...
    fun main(args: Array<String>) {
        println(aHof(10) { arg: Int -> arg + 10 })
